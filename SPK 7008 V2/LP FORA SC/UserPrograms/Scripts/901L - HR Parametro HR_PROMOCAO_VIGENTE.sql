IF NOT EXISTS(SELECT 1 FROM PARAMETROS WHERE PARAMETRO = 'HR_PROMOCAO_VIGENTE') 		
BEGIN
...
VALUES('HR_PROMOCAO_VIGENTE','PROMOCAO VIGENTE NAS LOJAS','QUANTO MAIS BASICO MELHOR','C',

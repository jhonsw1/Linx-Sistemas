IF NOT EXISTS(SELECT TOP 1 1 FROM PARAMETROS WHERE PARAMETRO = 'VALE_OMNI_CHAVE')
	...
	VALUES('VALE_OMNI_CHAVE', CAST(0 AS DATETIME), '', GETDATE(), '', 'Chave de acesso VALE OMNI', 'C', '', 0, '', 0, 0, 0 , 1, 1, 0, 1, 0, 0, 0, 0)

IF NOT EXISTS(SELECT TOP 1 1 FROM PARAMETROS WHERE PARAMETRO = 'VALE_OMNI_LOJISTA')
	INSERT INTO PARAMETROS (PARAMETRO, PENULT_ATUALIZACAO, VALOR_DEFAULT, ULT_ATUALIZACAO, VALOR_ATUAL, DESC_PARAMETRO, TIPO_DADO, RANGE_VALOR_ATUAL, GLOBAL, NOTA_PROGRAMADOR, ESCOPO, POR_USUARIO_OK, PERMITE_POR_EMPRESA, ENVIA_PARA_LOJA, PERMITE_POR_LOJA, PERMITE_POR_TERMINAL, PERMITE_ALTERAR_NA_LOJA, PERMITE_ALTERAR_NO_TERMINAL, ENVIA_PARA_REPRESENTANTE, PERMITE_POR_REPRESENTANTE, PERMITE_ALTERAR_NO_REPRESENTANTE)
	VALUES ('VALE_OMNI_LOJISTA', CAST(0 AS DATETIME), '', GETDATE(), '', 'Código do lojista VALE', 'C', '', 0, '', 0, 0, 0, 1, 1, 0, 1, 0, 0, 0, 0)

IF NOT EXISTS(SELECT TOP 1 1 FROM PARAMETROS WHERE PARAMETRO = 'VALE_OMNI_PASSWORD')
	INSERT INTO PARAMETROS (PARAMETRO, PENULT_ATUALIZACAO, VALOR_DEFAULT, ULT_ATUALIZACAO, VALOR_ATUAL, DESC_PARAMETRO, TIPO_DADO, RANGE_VALOR_ATUAL, GLOBAL, NOTA_PROGRAMADOR, ESCOPO, POR_USUARIO_OK, PERMITE_POR_EMPRESA, ENVIA_PARA_LOJA, PERMITE_POR_LOJA, PERMITE_POR_TERMINAL, PERMITE_ALTERAR_NA_LOJA, PERMITE_ALTERAR_NO_TERMINAL, ENVIA_PARA_REPRESENTANTE, PERMITE_POR_REPRESENTANTE, PERMITE_ALTERAR_NO_REPRESENTANTE)
	SELECT	'VALE_OMNI_PASSWORD'																		      AS PARAMETRO,
			CAST(0 AS DATETIME)																				  AS PENULT_ATUALIZACAO,
			''																								  AS VALOR_DEFAULT,
			GETDATE()																						  AS ULT_ATUALIZACAO,
			''																						          AS VALOR_ATUAL,
			'Senha de acesso VALE OMNI'          															  AS DESC_PARAMETRO,
			'C'																								  AS TIPO_DADO,
...
IF NOT EXISTS(SELECT TOP 1 1 FROM PARAMETROS WHERE PARAMETRO = 'VALE_OMNI_URL')
	INSERT INTO PARAMETROS (PARAMETRO, PENULT_ATUALIZACAO, VALOR_DEFAULT, ULT_ATUALIZACAO, VALOR_ATUAL, DESC_PARAMETRO, TIPO_DADO, RANGE_VALOR_ATUAL, GLOBAL, NOTA_PROGRAMADOR, ESCOPO, POR_USUARIO_OK, PERMITE_POR_EMPRESA, ENVIA_PARA_LOJA, PERMITE_POR_LOJA, PERMITE_POR_TERMINAL, PERMITE_ALTERAR_NA_LOJA, PERMITE_ALTERAR_NO_TERMINAL, ENVIA_PARA_REPRESENTANTE, PERMITE_POR_REPRESENTANTE, PERMITE_ALTERAR_NO_REPRESENTANTE)
	SELECT	'VALE_OMNI_URL'																			          AS PARAMETRO,
			CAST(0 AS DATETIME)																				  AS PENULT_ATUALIZACAO,
			''																								  AS VALOR_DEFAULT,
			GETDATE()																						  AS ULT_ATUALIZACAO,
			''																						          AS VALOR_ATUAL,

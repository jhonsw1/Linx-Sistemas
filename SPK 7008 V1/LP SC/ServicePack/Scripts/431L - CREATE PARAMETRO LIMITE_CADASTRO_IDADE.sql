...
IF NOT EXISTS(SELECT TOP 1 1 FROM PARAMETROS WHERE PARAMETRO = 'LIMITE_CADASTRO_IDADE')
	...
	SELECT	'LIMITE_CADASTRO_IDADE'   AS PARAMETRO,
			CAST(0 AS DATETIME)   AS PENULT_ATUALIZACAO,
			'0'	                  AS VALOR_DEFAULT,
			GETDATE()             AS ULT_ATUALIZACAO,
			'0'                   AS VALOR_ATUAL,
			'Limite de cadastro de idade.' AS DESC_PARAMETRO,
			'I'                   AS TIPO_DADO,

CREATE PROCEDURE [dbo].[LX_LJ_DETALHE_PRODUTO] (@PRODUTO VARCHAR(25), @CODIGO_TAB_PRECO VARCHAR(2), @FILIAL VARCHAR(25), @PESQUISA_FOTO BIT,@VALIDA_GTIN BIT = 1)      
...
BEGIN      
 ...
 --  BEGIN 
	...
	--	  PRODUTO = @PRODUTO  
	--	  AND INATIVO = 0  
	--	 GROUP BY PRODUTO, COR_PRODUTO, TAMANHO, GRADE,ID_SKU, TIPO_COD_BAR  
	--	 BEGIN  
	...
	--		  WHERE   
	--		   TIPO_COD_BAR <> 1  
	--		  GROUP BY PRODUTO, COR_PRODUTO, TAMANHO) T  
	--	   ON P.PRODUTO = T.PRODUTO   
	--	   AND P.COR_PRODUTO = T.COR_PRODUTO   
	--	   AND P.TAMANHO = T.TAMANHO   
	--	   AND P.CODIGO_BARRA = T.CODIGO_BARRA   
	--	   WHERE   
	--		P.TIPO_COD_BAR <> 1  
	...
	--	  PRODUTO = @PRODUTO
	--	  AND INATIVO = 0  
	--	GROUP BY PRODUTO, COR_PRODUTO, TAMANHO, GRADE,ID_SKU, TIPO_COD_BAR ,CODIGO_BARRA 
...
if @VALIDA_GTIN = 0 
  ...
  -- #4# [Fim]      
   ...
   ESTOQUE = ISNULL(CASE C.TAMANHO WHEN 1 THEN ES1 WHEN 2 THEN ES2 WHEN 3 THEN ES3 WHEN 4 THEN ES4 WHEN 5 THEN ES5 WHEN 6 THEN ES6 WHEN 7 THEN ES7      

CREATE PROCEDURE [DBO].[LX_GERA_NFE_SEFAZ_3_10]  @NOTAFISCAL VARCHAR(15), @SERIENOTA VARCHAR(6), @FILIALNOTA VARCHAR(25), @RETORNA_XML BIT = 0, @APP_VERSAO VARCHAR(20) = NULL
	WITH ENCRYPTION 
AS										
/*
...
-- ID2454 - Giedson Silva - #40# - (20/04/2016) - Retirada da soma dos campos FECP_DEST_VALOR e FECP_DEST na tag "vICMSUFDest"
...
DECLARE --@NOTAFISCAL VARCHAR(7), @SERIENOTA VARCHAR(6), @FILIALNOTA VARCHAR(25),  
		...
		@NF_NUMERO_REFERENCIADA char(1) --#35#
